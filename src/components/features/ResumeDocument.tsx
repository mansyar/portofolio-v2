...
// Lazy-loaded PDF components will be passed as props to avoid static import in initial bundle
interface PDFComponents {
  Document: typeof DocumentType;
  Page: typeof PageType;
  Text: typeof TextType;
  View: typeof ViewType;
  StyleSheet: typeof StyleSheetType;
}
...
export const ResumeDocument = ({ 
  ...
  // Create styles inside component to use the passed StyleSheet
